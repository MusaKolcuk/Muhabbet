...
const login = asyncErrorWrapper(async (req, res, next) => {
    ...
    if (!user.isVerified) {
        return next(new CustomError("Your account is not verified", 401));
    }
...
const updatePassword = asyncErrorWrapper(async (req, res, next) => {
    ...
    // Yeni parola ve parola tekrarını karşılaştırın
...
module.exports = { login, logout, getUser, forgotPassword, resetPassword, editDetails, updatePassword };
