...
const { createUser, deleteUser, updateUser, getAllUsers, getSingleUser, getUserGroups, deleteAllUsers, verifyAccount, addToContacts, getContacts, imageUpload, getAllUsersDeleteContacts } = require("../controllers/userController.js");
...
router.delete("/:userId/contacts", getAccessToRoute, getAllUsersDeleteContacts);
