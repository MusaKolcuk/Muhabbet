...
const getAllUsersDeleteContacts = asyncErrorWrapper(async (req, res, next) => {
    ...
    return res.status(200).json({
        success: true,
        message: "User's contacts have been deleted.",
    });
});
...
module.exports = { createUser, deleteUser, updateUser, getAllUsers, getSingleUser, getUserGroups, deleteAllUsers, verifyAccount, addToContacts, getContacts, imageUpload, getAllUsersDeleteContacts }